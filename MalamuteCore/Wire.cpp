...
void Wire::move()
{
    ...
    if(inCasingBackend && outCasingBackend)
    {
        ...
        QPointF inPosCasing = inCasing.plugScenePosition(m_backend->getPlugIndex(PlugType::IN),PlugType::IN);
        QPointF outPosCasing = outCasing.plugScenePosition(m_backend->getPlugIndex(PlugType::OUT),PlugType::OUT);
